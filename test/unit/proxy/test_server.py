...
class TestObjectController(unittest.TestCase):
    ...
    def test_POST_append_invalid_revision(self):
        with save_globals():
            self.app.object_post_as_copy = False
            controller = proxy_server.ObjectController(self.app, 'account',
                'container', 'object')
            ...
            self.assertEqual(res.body, 'Non-integer X-Append-To')
    ...
    def test_GET_invalid_revision(self):
        with save_globals():
            controller = proxy_server.ObjectController(self.app, 'account',
                'container', 'object')
            ...
            res = controller.GET(req)
            self.assertEqual(res.status_int, 400)
            self.assertEqual(res.body, 'Non-integer X-Revision')
